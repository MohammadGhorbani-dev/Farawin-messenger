    ...
    <>
      {!selectedContact ? (
        <div className="w-2/3 h-full flex flex-col bg-[#202329] justify-center text-2xl font-bold text-center max-lg:w-full">
          <span>مخاطب خود را انتخاب کنید</span>
          <img
            title="خروج از اکانت "
                  ...
                  >
                    ...
                    <div className="text-sm relative">
                      ...
                      {message.sender === localStorage.myUsername && (
                        ...
                        >
                          <img src={ImageDelete} alt="delete" title="حذف متن" />
                        </button>
                      )}
                      {message.sender === localStorage.myUsername && (
                        <button
          ...
          <div className="w-full h-14 lg:pr-5">
            <div className="w-full h-full rounded-2xl flex my-1 focus-within:bg-[#2E333D]">
              ...
              <input
                ...
                type="text"
                className="py-3 bg-inherit w-full px-5 h-full m-auto rounded-2xl focus:outline-none text-right text-lg"
                value={sendMessage}
              />
              <button
                type="button"
