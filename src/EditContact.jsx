...
export default function EditContact({
  ...
  return (
    <div
      className={`absolute flex justify-center items-center top-0 bottom-0 right-0 left-0 backdrop-blur-sm z-40  ${
        closeEditContact ? " hidden" : null
      }`}
    >
      <form className="relative flex items-center flex-col px-5 py-4 gap-y-4 w-96 rounded-3xl bg-[#2E333D] ">
        <div
          onClick={() => {
        ...
        <input
          ...
          type="text"
          id="numberPhone"
          className="h-10 rounded-xl focus:outline-none text-black p-3 disabled:bg-gray-300 "
          disabled
